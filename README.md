...
- 💻 4+ years in test automation (Python and Java)
...
- Interested in machine learning and building applications (backend, desktop)
- Interested in exploring C++ and Assembly to expand my understanding of programming and computer systems
- Planning to dive into electronics, robotics, and embedded systems: soldering, hardware projects, and programming microcontrollers

## Contacts

- [LinkedIn](https://www.linkedin.com/in/valeriymakarov/)
